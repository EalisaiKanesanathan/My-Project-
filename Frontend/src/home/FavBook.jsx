...
import FavBookImg from "../assets/Favbooks.png"
...
const FavBook = () => {
  return (
    ...
    <div className='space-y-6 md:w-1/2'>
        <h2 className='text-5xl my-5 font-bold md:w-3/4 leading-snug'>Find Your Favorite 
        <span className='text-blue-600'>Book Here!</span></h2>
        <p className='mb-10 text-lg md:w-5/6'>Find and read more books you'll love, and keep track of the books you want to read. 
